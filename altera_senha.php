...
mysql_query($sql_altera_senha_vendas,$connect);
$query_grid = mysql_query($sql_altera_senha_vendas,$connect);

while ($linha_senha = mysql_fetch_array($query_grid)) { 
$id_usu = $linha_senha['id'];
$usuario_atual = $linha_senha['senha'];
} 
}
?>
...
<div id="content">
  ...
  <div id="footer">
    <h1>site @2014 Todos os Direitos Reservados<br />
      <br />
      E-Mail:<a href="mailto:email@mail.com.br"> mail@mail.com.br</a><br />
      <br />
      <!--<br/>-->
    </h1>
  </div>
